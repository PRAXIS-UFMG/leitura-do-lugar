...
class PeriodsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create period" do
    assert_difference("Period.count") do
      post periods_url,
        params: {period: {description: @period.description, description_md: @period.description_md,
                          end_date: @period.end_date, name: @period.name, start_date: @period.start_date}}
    end
